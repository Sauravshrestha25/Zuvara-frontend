    ...
    <section className="immersive-section relative px-6 py-14 lg:px-10 lg:py-16">
      ...
      <div className="mx-auto max-w-7xl space-y-7 perspective-1200px">
        {/* <div className="fx-rise">
          ...
          >
            If the fit, comfort, or protection is not right, we help you fix it
            fast.
          </p>
        </div> */}
          ...
          <div className="grid gap-8 lg:grid-cols-12 lg:items-center">
            <div className="fx-float flex h-full flex-col justify-center lg:col-span-7">
              ...
              <p
                ...
                style={{ color: hexToRgba(theme.accent, 1) }}
              >
                If the fit, comfort, or protection is not right, reach out
              ...
              >
                ...
                <div>Help with sizing and comfort issues</div>
                <div>Clear, parent-first guidance</div>
              </div>
            </div>
