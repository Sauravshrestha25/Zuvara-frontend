      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-6 max-w-5xl">
        ...
        <div className="mb-10">
          <h2 className="text-3xl lg:text-4xl font-semibold text-foreground font-poppins">
            Featured <span className="text-[#8cd700]">Products</span>
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 lg:gap-6">
          {products.map((product) => (
            <Link key={product.id} href={`/product/${product.id}`}>
              <div className="group h-full flex flex-col bg-white rounded-lg border border-zinc-100 overflow-hidden hover:border-zinc-200  transition-all duration-400">
        ...
        <div className="text-center mt-10">
          <button className="inline-block bg-foreground hover:bg-teal-700 text-white font-medium text-smsemibold px-8 py-3 rounded-full transition-all">
            View All Products
          </button>
        </div>
      </div>
