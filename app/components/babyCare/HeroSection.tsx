...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-screen h-[75vh] lg:h-screen overflow-hidden flex flex-col lg:flex-row px-4 sm:px-6 lg:px-6 mx-auto! max-w-7xl">
      ...
      <div className="relative w-full h-full lg:w-1/2 flex flex-col justify-around lg:justify-center gap-0 lg:gap-16 md:mb-0 text-left">
        <div className="">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="lg:text-lg text-zinc-700 mb-2 md:mb-4 max-w-xl"
          >
      ...
      {/* baby playing video */}
      <div className="w-[50%] flex items-center absolute bottom-0 right-0 lg:relative">
        <video
          src="/videos/babyPlaying.webm"
          autoPlay
          muted
          playsInline
          loop
          controls={false}
          className="pointer-events-none select-none size-[95%] outline-none border-none ring-0 appearance-none transform-gpu"
        />

        <div
          className="absolute left-0 w-full h-full pointer-events-auto"
          style={{ top: "-80px" }}
        >
          <img
            id="plane"
