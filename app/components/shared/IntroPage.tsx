  ...
  return (
    <main className="min-h-screen w-full relative overflow-hidden flex flex-col items-center justify-center tracking-tight bg-babyCare pt-20">
      ...
      <div className="text-center mb-6 lg:mb-12 space-y-3 z-10">
        <span className="text-[10px] font-black uppercase tracking-[0.5em] text-zinc-600 opacity-60">
          Welcome to Zuvara
        </span>
      ...
      <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center justify-center gap-8 relative z-10 pb-16">
        {sections.map((section) => (
          <Link
            key={section.id}
            href={section.href}
            className="w-full lg:w-100 group"
          >
            <motion.div
              ...
              className={`relative rounded-[2.5rem] overflow-hidden flex flex-col justify-between p-8 shadow-xl cursor-pointer`}
            >
              ...
              <div className="relative z-10 space-y-3">
                ...
                >{isSmallerDevice ? section.title : section.title.split(" ")[0]} <br />
                  <span
                ...
                <p
                  className={`max-w-[280px] text-xs font-medium leading-relaxed transition-colors duration-300 ${
                    hoveredSection === section.id
                      ? "text-white/80"
                      : "text-zinc-500"
                  }`}
